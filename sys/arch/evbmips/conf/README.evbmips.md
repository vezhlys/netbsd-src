...
| -----------------------------	| ----------------	|------------------------------	|-----------------------------------------------------------------------------------------------------------------------------	|
| ADM5210			| 2007/03/20	| evbmips-el			| Infineon ADM5120 (MIPS32 4Kc) based boards and routers, including RouterBOARD 100 series.	|
...
| MALTA32			| 2009/12/14	| evbmips(n)64-el,eb	| MALTA 64-bit kernel configuration with 32-bit userland.									|
| MALTA32.MP			| 2009/12/14	| evbmips(n)64-el,eb	| MALTA 64-bit MP kernel configuration with 32-bit userland.								|
...
| MIPSSIM64			| 2021/01/27	| evbmips(n)64-el,eb	| QEMU MIPS "mipssim" simulator (64-bit kernel.)										|
...
| XLSATX32			| 2011/02/20	| evbmips(n)64-el,eb	| XLSATX 64-bit kernel configuration with 32-bit userland.									|
...
## Notes:
* INSALL_* kernels represent installation kernel configurations.
* *.MP	represent multiprocessor support.
* *el targets are little-endian.
* *eb targets are big-endian.
* *64-* targets are for 64-bit kernels.
* *(n)* targets support n64 ABI.